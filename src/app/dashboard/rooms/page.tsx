...
// 🎯 Portal Dropdown Component - لحل مشكلة z-index
...
function PortalDropdown({ isOpen, onClose, triggerRef, stats, onFilterChange, t }: PortalDropdownProps) {
...
export default function RoomsPage() {
  const { user } = useAuth();
  const { t } = useLanguage();
  const { roomPrices, setRoomPrices, roomTypes, setRoomTypes } = useContext<RoomsContextType>(RoomsContext);
        ...
        <div className="bg-gradient-to-r from-slate-800/80 via-blue-900/80 to-purple-900/80 backdrop-blur-xl rounded-2xl p-6 shadow-xl border border-white/10">
          ...
          <div className="flex items-center flex-wrap gap-3">
            ...
            <PortalDropdown
              ...
              onClose={() => setIsReportDropdownOpen(false)}
