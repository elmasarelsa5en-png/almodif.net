  ...
  useEffect(() => {
    const loadMenuItems = async () => {
      try {
        ...
        console.log('🍽️ Loaded restaurant items:', items.length);
    ...
    const unsubscribe = subscribeToMenuItems((allItems) => {
      ...
      console.log('🍽️ Restaurant items updated:', restaurantItems.length);
            ...
            {loading ? (
              <div className="flex items-center justify-center h-96">
                <div className="text-center">
                  ...
                  <p className="text-orange-200 text-lg">جاري تحميل القائمة...</p>
                </div>
              </div>
            ) : menuItems.length === 0 ? (
              <div className="text-center py-20">
                <Utensils className="h-20 w-20 text-orange-400/50 mx-auto mb-4" />
