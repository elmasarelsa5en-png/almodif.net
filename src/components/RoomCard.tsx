...
import { Room, RoomStatus, ROOM_STATUS_CONFIG, ROOM_TYPE_CONFIG } from '@/lib/rooms-data';
import { Badge } from '@/components/ui/badge';
import { CheckCircle2, BedDouble, Hammer, Trash2, Clock, AlertTriangle } from 'lucide-react';
...
const RoomCard = React.memo(({ room, onOpenDetails, onContextMenu, roomPrices, roomTypes }: RoomCardProps) => {
  const { t } = useLanguage();
